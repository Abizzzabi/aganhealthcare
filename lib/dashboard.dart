  ...
  Widget build(BuildContext context) {
      ...
      child: Container(
        child: Column(
          ...
          child:Container(
            ...
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color:const Color.fromRGBO(223, 242, 216, 1),),
          
            )
          ),
          const  Padding(padding:EdgeInsets.all(20),
            child: Text('Treatments',style:TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold)),
            ),
    ...
    MaterialPageRoute(builder: (context) => const Neurologist()),
        ...
        child:   Text('Dentist',style: TextStyle(color: Color.fromRGBO(78, 121, 63, 1),fontSize: 15,fontWeight: FontWeight.bold),) ,
          ...
          Row(children: const [
            Padding(padding: EdgeInsets.only(top:3,left: 30),
            child:Text('Orthopedic Surgoen',style: TextStyle(color: Color.fromRGBO(78, 121, 63, 1),fontSize: 15,fontWeight: FontWeight.bold),) ,
            ),
            SizedBox(width:50),
             Padding(padding: EdgeInsets.only(top:3,),
        child:   Text('Paediatrician',style: TextStyle(color: Color.fromRGBO(78, 121, 63, 1),fontSize: 15,fontWeight: FontWeight.bold),) ,
            )  ],),const SizedBox(height: 20,),
          Row(children: const [
            Padding(padding: EdgeInsets.only(left: 15),
           child: Text('Your History',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),)
            ),
    ...
    MaterialPageRoute(builder: (context) => const History()),
          ...
          child: Card(
            child: Container(height: 200,width: 320,
