                    ...
                    GestureDetector(
                        ...
                        child: const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/cordialogist.png'),
                          ),
                        )),
                    const SizedBox(
                      width: 50,
                    ...
                    GestureDetector(
                        ...
                        child: const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/opthalmologist.png'),
                          ),
                        ))
                  ]),
                ),
                    ...
                    GestureDetector(
                        ...
                        child: const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/gynaecologist.png'),
                          ),
                        ))
                  ]),
                ),
                    ...
                    GestureDetector(
                        ...
                        child: const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/diabetologist.png'),
                          ),
                        )),
                    const SizedBox(
                      width: 50,
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const Neurologist()),
                          );
                        },
                        child: const CircleAvatar(
                          radius: 70,
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/neurologist.png'),
                          ),
                        ))
                  ]),
                ),
                    ...
                    GestureDetector(
                        ...
                        child: const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/dermotologist.png'),
                          ),
                        )),
                    const SizedBox(
                      width: 50,
                    ...
                    GestureDetector(
                        ...
                        child: const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/dentist.png'),
                          ),
                        ))
                  ]),
                ),
                    ...
                    GestureDetector(
                        ...
                        child: const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/ortho.png'),
                          ),
                        )),
                    const SizedBox(
                      width: 50,
                    ...
                    GestureDetector(
                        ...
                        child: const CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 60,
                            backgroundImage:
                                AssetImage('assets/image/paediatrician.png'),
                          ),
                        ))
                  ]),
                ),
